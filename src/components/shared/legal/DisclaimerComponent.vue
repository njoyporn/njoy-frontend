...
<template>
    <h1 class="w-full text-6xl text-center font-bold text-white p-4">Disclaimer</h1>
    <p class="w-full text-center">This website is a personal project and basically the equivalent to Barney Stinson's porn shelf</p>
