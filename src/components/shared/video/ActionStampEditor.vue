...
<template>
    <div class="w-full h-full flex justify-center items-center relative z-30">
        ...
        <div v-if="showAdvanced" class="h-[40rem] w-[32rem] border rounded-r-lg bg-orange-600 bg-opacity-75 p-4 grid grid-rows-[1fr_10fr]">
            ...
            <div class="w-full h-full">
                <div v-for="(actionStamp, i) of actionStamps" class="grid grid-cols-[3fr_6fr_2fr_1fr] w-full  bg-gray-600 h-20 items-center mb-2 rounded-md p-1 overflow-y-auto">
